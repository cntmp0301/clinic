                    ...
                    <table class="table align-items-center table-flush dtab">
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="#" data-target="#showdoneDetail" data-toggle="modal" data-patientId="{{ $row -> patient_id }}" title="รายละเอียด" class="btn btn-primary btnDetail"><i class="fas fa-solid fa-eye"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
